...
public class ExampleServer implements NetworkReqListener {
	...
	private static final String[] TO_RECEIVE = new String[] { "I want to get 3 answers", "This is second message",
	        "Bye bye" };
	...
	private Answer createAnswer(Request r, int resultCode, int enumType) {
		...
		Avp exchengeData = answerAvps.addAvp(exchangeDataCode, TO_RECEIVE[toReceiveIndex], vendorID, true, false,
		        false); // value
		// is
		// set
		// on
